...
int main()
{
  ...
  int num1 = 123;
  cout << "Input: " << num1 << "\nOutput: " << solution.numberToWords(num1) << endl;

  int num2 = 12345;
  cout << "Input: " << num2 << "\nOutput: " << solution.numberToWords(num2) << endl;

  int num3 = 1234567;
  cout << "Input: " << num3 << "\nOutput: " << solution.numberToWords(num3) << endl;

  return 0;
}

/*
Time Complexity: O(1) - Since the maximum number of digits in the number is fixed (32-bit integer).
Space Complexity: O(1) - Only a fixed amount of space is used for storing words.
*/
